...
class SuppliesOutgoingReport(Base):
    ...
    created_by = relationship("User", foreign_keys=[created_by_id], backref="created_supplies_outgoing_reports")
    updated_by = relationship("User", foreign_keys=[updated_by_id], backref="updated_supplies_outgoing_reports")
    deleted_by = relationship("User", foreign_keys=[deleted_by_id], backref="deleted_supplies_outgoing_reports")
    rm_code = relationship("RawMaterial", foreign_keys=[rm_code_id], backref="rm_supplies_outgoing_reports")
    warehouse = relationship("Warehouse", foreign_keys=[warehouse_id], backref="warehouse_supplies_outgoing_reports")
    status = relationship("Status", foreign_keys=[status_id], backref="status_supplies_outgoing_reports")
