...
class SuppliesOutgoingFormCreate(SuppliesOutgoingForm):
    created_by_id: Optional[UUID] = None
    updated_by_id: Optional[UUID] = None

class SuppliesOutgoingFormUpdate(SuppliesOutgoingForm):
    pass

class SuppliesOutgoingFormResponse(BaseModel):
    id: UUID
    raw_material: str
    qty_kg: float
    ref_number: str
