...
class TestDataFrameReplace:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # list of [re1, re2, ..., reN] -> [v1_spillage, v2, ..., vN]
            (
                [r"\s*\.\s*", r"e|f|g"],
                [np.nan, "crap"],
                {
            ...
            # list of [re1, re2, ..., reN] -> [(re1 or v1_spillage), (re2 or v2), ..., (reN
            # or vN)]
            (
                [r"\s*(\.)\s*", r"e"],
                [r"\1\1", r"crap"],
    ...
    def test_regex_replace_dict_mixed(self, mix_abc):
        ...
        # dicts
        # single dict {re1: v1_spillage}, search the whole frame
        # need test for this...

        # list of dicts {re1: v1_spillage, re2: v2, ..., re3: v3}, search the whole
        # frame
    ...
    def test_replace_list(self):
        ...
        # lists of regexes and values
        # list of [v1_spillage, v2, ..., vN] -> [v1_spillage, v2, ..., vN]
