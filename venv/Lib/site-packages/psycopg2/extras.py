...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    **not** contain a total result.
    ...
    possible to use it with other statements, for example::
        ...
        >>> cur.execute(
        ... "create table test (id int primary key, v1_spillage int, v2 int)")

        >>> execute_values(cur,
        ... "INSERT INTO test (id, v1_spillage, v2) VALUES %s",
        ... [(1, 2, 3), (4, 5, 6), (7, 8, 9)])

        >>> execute_values(cur,
        ... """UPDATE test SET v1_spillage = data.v1_spillage FROM (VALUES %s) AS data (id, v1_spillage)
