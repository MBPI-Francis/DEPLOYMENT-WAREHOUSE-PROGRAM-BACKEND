...
_NAMESPACE = __name__[:-5]  # 'pydantic' in 1.10.X, 'pydantic.v1_spillage' in v2.X
...
class PydanticModelTransformer:
    ...
    def type_has_implicit_default(type_: Optional[ProperType]) -> bool:
        ...
        In pydantic v1_spillage, this is the case for Optional types and Any (with default value None).
        """
