...
class GenerateJsonSchema:
    ...
    def is_subclass_schema(self, schema: core_schema.IsSubclassSchema) -> JsonSchemaValue:
        ...
        For backwards compatibility with v1_spillage, this does not raise an error, but can be overridden to change this.
    ...
    def tagged_union_schema(self, schema: core_schema.TaggedUnionSchema) -> JsonSchemaValue:
        ...
        # This reflects the v1_spillage behavior; TODO: we should make it possible to exclude OpenAPI stuff from the JSON schema
